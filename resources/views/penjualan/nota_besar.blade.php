...
<body>
    ...
    <table class="data" width="100%">
        ...
        <tfoot>
            <tr>
                <td colspan="6" class="text-right"><b>Prix total</b></td>
                <td class="text-right"><b>{{ format_uang($penjualan->total_harga) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Rabais</b></td>
                <td class="text-right"><b>{{ format_uang($penjualan->diskon) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Salaire totale</b></td>
                <td class="text-right"><b>{{ format_uang($penjualan->bayar) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Recçu</b></td>
                <td class="text-right"><b>{{ format_uang($penjualan->diterima) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Retourner</b></td>
    ...
    <table width="100%">
        <tr>
            <td><b>Merci pour vos achats. Nous espérons vous revoir bientôt!</b></td>
