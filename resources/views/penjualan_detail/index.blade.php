            ...
            <div class="box-body">
                ...
                <form class="form-produk">
                    ...
                    <div class="form-group row">
                        <label for="kode_produk" class="col-lg-2">Code produit</label>
                        <div class="col-lg-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                            ...
                            <div class="form-group row">
                                <label for="kode_member" class="col-lg-2 control-label">Membre</label>
                                <div class="col-lg-8">
                                    <div class="input-group">
                            ...
                            <div class="form-group row">
                                <label for="bayar" class="col-lg-2 control-label">Salaire</label>
                                <div class="col-lg-8">
                                    <input type="text" id="bayarrp" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="diterima" class="col-lg-2 control-label">Reçu</label>
                                <div class="col-lg-8">
                                    <input type="number" id="diterima" class="form-control" name="diterima" value="{{ $penjualan->diterima ?? 0 }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="kembali" class="col-lg-2 control-label">Retourner</label>
                                <div class="col-lg-8">
