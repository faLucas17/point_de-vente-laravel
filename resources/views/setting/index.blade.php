            ...
            <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="alert alert-info alert-dismissible" style="display: none;">
                        ...
                        <i class="icon fa fa-check"></i> Changements sauvegardés avec succès
                    </div>
                    <div class="form-group row" >
                        <label for="nama_perusahaan" class="col-lg-2 control-label">Nom Entreprise</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="alamat" class="col-lg-2 control-label">Adresse</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="path_kartu_member" class="col-lg-2 control-label">Carte de membre</label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group row">
                        <label for="diskon" class="col-lg-2 control-label">Rabais</label>
                        <div class="col-lg-2">
                    ...
                    <div class="form-group row">
                        <label for="tipe_nota" class="col-lg-2 control-label">Type de note</label>
                        <div class="col-lg-2">
                            <select name="tipe_nota" class="form-control" id="tipe_nota" required>
                                <option value="1">Petite facture</option>
                                <option value="2">Facture PDF</option>
                            </select>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                ...
                <div class="box-footer text-right">
                    <button class="btn btn-sm btn-flat btn-primary"><i class="fa fa-save"></i> Sauvegarder les modifications</button>
                </div>
            </form>
        </div>
    </div>
