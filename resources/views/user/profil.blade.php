...
@section('breadcrumb')
    @parent
    <li class="active">Editer le Profil</li>
@endsection
        ...
        <div class="box">
            <form action="{{ route('user.update_profil') }}" method="post" class="form-profil" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <label for="old_password" class="col-lg-2 control-label">ancien mot de passe</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="password_confirmation" class="col-lg-2 control-label">Confirmer mot de passe</label>
                        <div class="col-lg-6">
        ...
        $('.form-profil').validator().on('submit', function (e) {
            if (! e.preventDefault()) {
                ...
                .done(response => {
                    ...
                    $('.tampil-foto').html(`<img src="{{ url('c:\Users\DELL\OneDrive\Images\php logo\FSS.png') }}${response.foto}" width="200">`);
                    $('.img-profil').attr('src', `{{ url('c:\Users\DELL\OneDrive\Images\php logo\FSS.png') }}/${response.foto}`);
