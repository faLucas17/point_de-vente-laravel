            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="nama_batiment" class="col-lg-2 col-lg-offset-1 control-label">Batiment</label>
                        <div class="col-lg-6">
                            <input type="text" name="nama_batiment" id="nama_batiment" class="form-control" required autofocus>
